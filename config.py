...
USER_DATA_PATH = "user_behavioral_data.csv"   # input behavioural CSV
OUTPUT_DIR     = "iteration_0_before_learning"   # primary output dir (Task 1 & 2)
OUTPUT_DIR_0   = "iteration_0_before_learning"   # alias (before learning)
OUTPUT_DIR_1   = "iteration_1_after_learning"    # after learning (Task 3)
